...
Duel_Init: ; 103d3 (4:43d3)
	...
	ld hl, Unknown_1045b
	add hl, bc
	ld a, $02 ; this replaces the 2 calls to ld a, [hli] so it points to MusclesforBrainsDeckName instead
	; ld a, [hli]
	ld [wTxRam2], a
	; ld a, [hli]
	ld [wTxRam2 + 1], a
	...
	or c
	; jr z, .asm_10425
	jr .asm_10425 ; this prevents the deck name from being written
	ld hl, Unknown_10456
